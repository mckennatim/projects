...
static const CT_Config ct_sensors[4] = {
  {0, GAIN_ONE, 0.0001875,  104.7, 0.922, 15, .3, "ASHP-fl1"},
  {1, GAIN_ONE, 0.0001875,  104.7, 0.922, 15, .3, "Solar-12pv"},
  {2, GAIN_ONE, 0.0001875,  104.7, 0.922, 50, .3, "EV-charger"},
  {3, GAIN_ONE, 0.0001875,  104.7, 0.922, 15, .3, "Boiler"},
};
